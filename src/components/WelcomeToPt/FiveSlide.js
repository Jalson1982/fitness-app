      ...
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.description}>
          Things can get pretty confusing if we don't get the units right.
            ...
            <View style={{flexDirection:'row', alignItems:'center',justifyContent:'space-between', height:60, width:widthPercentageToDP('90%')}}>
                <View>
            ...
            <View style={{height:0.8,backgroundColor:'gray', width:widthPercentageToDP('90%'), opacity:0.3}} />
            <View style={{flexDirection:'row', alignItems:'center',justifyContent:'space-between', height:60, width:widthPercentageToDP('90%')}}>
                <View>
                <Text>Metric (kg,cm) </Text>
                </View>
